...
void Tutorial4::Update(float dt)
{
...
void Tutorial4::LoadObject(char *path)
{
...
GLuint Tutorial4::LoadShaderFromFile(std::string path, GLenum shaderType)
{
	GLuint shaderID = 0;
	string shaderString;
